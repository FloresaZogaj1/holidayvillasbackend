// Add payment initialization route for BKT 3D Pay
import crypto from "crypto";

const CLIENT_ID = process.env.BKT_CLIENT_ID || "530061270";
const STORE_KEY = process.env.BKT_STORE_KEY || "SKEY3319";
const GATE_URL = process.env.BKT_3D_GATE || "https://pgw.bkt-ks.com/fim/est3Dgate";
const OK_URL = process.env.BKT_OK_URL || "https://holidayvillasbackend.onrender.com/api/payments/ok";
const FAIL_URL = process.env.BKT_FAIL_URL || "https://holidayvillasbackend.onrender.com/api/payments/fail";
